...
public class DictionaryAdapter extends RecyclerView.Adapter<DictionaryAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View v) {
            super(v);
            word = (TextView) v.findViewById(com.antat.dictionary.R.id.word);
            translation = (TextView) v.findViewById(com.antat.dictionary.R.id.translation);
        }
    }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(com.antat.dictionary.R.layout.dictionary_record_view, parent, false);
